...
<html class="no-js"> 
    <head>
        ...
        <title>Greign Estates | Properties </title>
                    ...
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        ...
                        <div class="single-property-wrapper">
                            <div class="single-property-header">                                          
                                <h1 class="property-title pull-left">2 and 3 BR Apartments in Westlands R774</h1>
                                <span class="property-price pull-right">KES 160,000</span>
                            </div>
                            <div class="center"><img src="img/demo/property-1.jpg"></div>
                            ...
                            <div class="property-meta entry-meta clearfix ">   
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 p-b-15">
                                    ...
                                    <span class="property-info-entry">
                                        ...
                                        <span class="property-info-value">2 and 3</span>
                                    </span>
                                </div>
                            ...
                            <div class="section">
                                ...
                                <div class="s-property-content">
                                    <p>2 Bedroom and 3 Bedroom, furnished apartments in Westlands, Nairobi.</p>
                                </div>
                            </div>
                            ...
                            <div class="section property-features">      
                                ...
                                <ul>
                                    <li><a href="#">Gym</a></li>   
                                    <li><a href="#">Borehole</a></li>
                                    <li><a href="#">Automatic Generator</a></li>
                                    <li><a href="#">CCTV Surveillance</a></li>
                                    <li><a href="#">Lifts</a></li>
                                    <li><a href="#">Water Reservoir</a></li>
                                </ul>
